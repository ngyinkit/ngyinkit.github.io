const app = Vue.createApp({
    data() {
        return {
            projects: [
                {type: 'Internship', source: 'resources/peruse.jpg', name: 'Peruse', link: 'https://github.com/0venoven/Peruse', text: 'A collaboration with another intern during one of my internships. It is a PoC password scanner built using PySide6, SQLite, python-nmap, and THC-Hydra which scans for weak passwords on a network.'},
